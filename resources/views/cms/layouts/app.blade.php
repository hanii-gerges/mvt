...
@include("cms.layouts.parts.header")
...
<div class="page-wrapper">
    ...
    @include("cms.layouts.parts.navbar")
    <!-- End Top navigation-->

    <!-- START SIDEBAR-->
    @include("cms.layouts.parts.sidebar")
    <!-- END SIDEBAR-->
    ...
    <div class="content-wrapper">
        ...
        @include("cms.layouts.parts.page-footer")
    </div>
</div>
...
@include("cms.layouts.parts.loading")
...
@include("cms.layouts.parts.footer")
